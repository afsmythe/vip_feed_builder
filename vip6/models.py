...
class ExternalGeospatialFeature(models.Model):
    id = models.CharField(primary_key = True, max_length = 50)
    ExternalFileId = models.ForeignKey(ExternalFile, db_column = 'ExternalFileId', on_delete = models.CASCADE, max_length = 50)
    FileFormat = models.CharField(max_length = 50, blank = True, null = True)
    ShapeIdentifier = models.CharField(max_length = 50, blank = True, null = True)

class SpatialBoundary(models.Model):
    ExternalGeospatialFeature = models.ForeignKey(ExternalGeospatialFeature, on_delete = models.CASCADE, max_length = 50)
...
class Precinct(models.Model):
    ...
    SpatialBoundary = models.ForeignKey(SpatialBoundary, on_delete = models.CASCADE, max_length = 50, blank = True, null = True)
